...
const personalTournaments = [
  {
    ...
    fruits: 'いちご',
    color: css({ bg: 'indigo.100', rounded: '2xl', p: '8' }),
    ...
    <main className={css({ minH: '100vh', w: 'full', py: '12', px: '4' })}>
      <div className="container">
          ...
          <div className={css({ display: 'grid', gridTemplateColumns: 'repeat(1, minmax(0, 1fr))', md: { gridTemplateColumns: 'repeat(2, minmax(0, 1fr))' }, gap: '4' })}>
            <a
              ...
              className={css({
                ...
                _hover: { bg: 'blue.700', backgroundSize: '200% 200%' },
              })}
            >
              <Image
            ...
            <a
              ...
              className={css({
                ...
                backgroundPosition: 'center',
                backgroundRepeat: 'no-repeat',
                _hover: { bg: 'black', backgroundSize: '200% 200%' },
              })}
            >
              <Image
        ...
        <section className={css({ mb: '16' })}>
          <h2 className={`${darumadrop.className} ${css({ fontSize: '3xl', mb: '8', color: 'gray.800' })}`}>
            公式大会
          </h2>
          ...
          <div className={css({ display: 'flex', flexDirection: 'column', gap: '6' })}>
            {officialTournaments.map((tournament) => (
              <div
                ...
                className={tournament.color}
              >
                <div className={css({ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', mb: '4' })}>
                  <h3 className={`${darumadrop.className} ${css({ fontSize: '2xl', color: 'gray.800' })}`}>
                    {tournament.title}
                  </h3>
                  <span className={css({ display: 'inline-block', px: '3', py: '1', bg: 'white', rounded: 'full', fontSize: 'xs', fontWeight: 'bold', color: 'gray.700' })}>
                    {tournament.fruits}
                  </span>
                </div>

                <p className={css({ color: 'gray.700', lineHeight: 'relaxed', fontSize: 'base' })}>
          ...
          <div className={css({ display: 'flex', flexDirection: 'column', gap: '6' })}>
            {personalTournaments.map((tournament) => (
              ...
              >
                ...
                <p className={css({ color: 'gray.700', lineHeight: 'relaxed', fontSize: 'base', mb: '4' })}>
                  {tournament.description}
                </p>
          ...
          <div className={css({ display: 'grid', gridTemplateColumns: 'repeat(1, minmax(0, 1fr))', md: { gridTemplateColumns: 'repeat(2, minmax(0, 1fr))' }, gap: '6' })}>
            <Link href="/build">
              <div className={`main-background ${css({
                ...
                <h3 className={`${darumadrop.className} ${css({ fontSize: 'xl', mb: '2' })}`}>
                  デッキをつくる
                </h3>
